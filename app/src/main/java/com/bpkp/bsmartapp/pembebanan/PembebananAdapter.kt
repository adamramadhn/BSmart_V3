...
class PembebananAdapter : RecyclerView.Adapter<PembebananAdapter.ListViewHolder>(){
    private var listData = ArrayList<PembebananResponse>()
    var onItemClick: ((PembebananResponse) -> Unit)? = null
...
//    }
    ...
    fun addList(items: List<PembebananResponse>) {
    ...
    inner class ListViewHolder(private val binding: ItemListSuratTugasBinding) :
        ...
        fun bind(data: PembebananResponse) {
